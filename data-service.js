...
module.exports.updateEmployee = function (employeeData) {
    return new Promise(function (resolve, reject){
        employees.forEach(emp => {
            if(emp.employeeNum == employeeData.employeeNum){
                emp.firstName = employeeData.firstName;                
                emp.lastName = employeeData.lastName;
                emp.email = employeeData.email;
                emp.addressStreet = employeeData.addressStreet;
                emp.addressState = employeeData.addressState;
                emp.addressPostal = employeeData.addressPostal;
                emp.addresCity   = employeeData.addresCity;
                emp.isManager    = employeeData.isManager;
                emp.employeeManagerNum = employeeData.employeeManagerNum;
